...
/*********************************************************************
    admin.php
**********************************************************************/
//TODO: Do on-demand require...save some mem. But si saa hii
//Files we might need.
...
if(!$thisuser or !$thisuser->isadmin()){
    ...
    require('index.php'); // just in case msee!!
    exit;
}
...
//Access checked out OK...lets do the do  baby
...
switch($thistab){
    ...
    case 'dashboard':
	    ...
	    $nav->addSubMenu(array('desc'=>'Post to NoticeBoard','href'=>'admin.php?t=add','iconclass'=>'attachment'));
		$nav->addSubMenu(array('desc'=>'View Notices','href'=>'admin.php?t=view','iconclass'=>'attachment'));
