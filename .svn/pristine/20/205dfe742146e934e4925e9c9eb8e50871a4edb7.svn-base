<? if(!defined('OSTSCPINC') || !is_object($thisuser) || !$thisuser->isStaff() || !is_object($nav)) die('Access Denied Kwaheri msee'); ?>
<html>
<head>
...
?>
<title>LAN Support Staff Control Panel</title>
...
<div id="container">
    <div id="header">
        ...
        <p id="info">Jambo, <strong><?=$thisuser->getUsername()?></strong> 
           <?php
            ...
            <?}?>
            | <a href="profile.php?t=pref">My Account</a> | <a href="logout.php">Log Out</a></p>
    </div>
    <div id="nav">
