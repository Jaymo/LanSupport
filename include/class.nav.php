...
class StaffNav {
    ...
    function StaffNav($pagetype='staff'){
        ...
        if($thisuser->isAdmin() && strcasecmp($pagetype,'admin')==0) {
            $tabs['dashboard']=array('desc'=>'NoticeBoard','href'=>'admin.php?t=dashboard','title'=>'Admin Dashboard');
			...
			//$tabs['topics']=array('desc'=>'NoticeBoard','href'=>'admin.php?t=topics','title'=>'NoticeBoard');
        }else {
		    $tabs['dashboard']=array('desc'=>'NoticeBoard','href'=>'mboardsta.php','title'=>'Admin Dashboard');
