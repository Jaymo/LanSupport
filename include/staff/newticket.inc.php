...
<table width="80%" border="0" cellspacing=1 cellpadding=2>
   <form action="tickets.php" method="post" enctype="multipart/form-data">
	...
	<tr>
        <td align="left"><b>Department ticket was Raised:</b></td>
        <td>
            <select name="source">
                <option value="" selected >Select Department Source</option>
                <option value="Phone" <?=($info['source']=='Phone')?'selected':''?>>Billing</option>
                <option value="Email" <?=($info['source']=='Email')?'selected':''?>>Support</option>
                <option value="Other" <?=($info['source']=='Other')?'selected':''?>>Sales</option>
            </select>
            &nbsp;<font class="error"><b>*</b>&nbsp;<?=$errors['source']?></font>
        </td>
    </tr>
    <tr>
       <?=($info['source']=='Email')?'selected':''?>
    </tr>
    <tr>
